...
export type SignOutSuccess = Action<USER_ACTION_TYPES.SIGN_IN_SUCCESS>
export type SignOutFailed = Action<USER_ACTION_TYPES.SIGN 
...
export const signOutStart = ():Sign =>
